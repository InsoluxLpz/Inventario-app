...
import { Box, Button, FormControlLabel, Grid2, IconButton, Paper, Switch, TextField, Typography } from "@mui/material";
...
export const CatalogoServicios = () => {
    ...
    return (
        <>
                        ...
                        <Table stickyHeader aria-label="sticky table">
                            ...
                            <TableBody>
                                {serviciosFiltrados.map((servicio) => (
                                    <TableRow key={servicio.id} sx={{
                                        backgroundColor: getStatusColor(servicio.status), "&:hover": {
            ...
            <EditarServiciosModal onClose={handleCloseModalEdit} modalOpen={openModalEditar} servicio={servicioSeleccionado} actualizarLista={actualizarLista} ListaServicios={servicios} />
